...
fun TestConfiguration.createOrtTempDir(vararg infixes: String): File {
    val dir = (this as Any).createOrtTempDir(*infixes)
...
fun TestConfiguration.createOrtTempFile(prefix: String? = null, suffix: String? = null): File {
    val file = (this as Any).createOrtTempFile(prefix, suffix)
